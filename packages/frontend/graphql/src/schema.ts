...
export type AdminServerConfigQuery = { __typename?: 'Query', serverConfig: { __typename?: 'ServerConfigType', version: string, baseUrl: string, name: string, features: Array<ServerFeature>, type: ServerDeploymentType, initialized: boolean, availableUserFeatures: Array<FeatureType>, credentialsRequirement: { __typename?: 'CredentialsRequirementType', password: { __typename?: 'PasswordLimitsType', minLength: number, maxLength: number } } } };
...
export type DeleteBlobMutation = { __typename?: 'Mutation', deleteBlob: boolean };
...
export type CancelSubscriptionMutation = { __typename?: 'Mutation', cancelSubscription: { __typename?: 'UserSubscription', id: string | null, status: SubscriptionStatus, nextBillAt: string | null, canceledAt: string | null } };
...
export type ChangeEmailMutation = { __typename?: 'Mutation', changeEmail: { __typename?: 'UserType', id: string, email: string } };
...
export type CreateChangePasswordUrlMutation = { __typename?: 'Mutation', createChangePasswordUrl: string };
...
export type CopilotQuotaQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', copilot: { __typename?: 'Copilot', quota: { __typename?: 'CopilotQuota', limit: number | null, used: number } } } | null };
...
export type CleanupCopilotSessionMutation = { __typename?: 'Mutation', cleanupCopilotSession: Array<string> };
...
export type CreateCopilotMessageMutation = { __typename?: 'Mutation', createCopilotMessage: string };
...
export type CreateCopilotSessionMutation = { __typename?: 'Mutation', createCopilotSession: string };

export type CreateCustomerPortalMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateCustomerPortalMutation = { __typename?: 'Mutation', createCustomerPortal: string };
...
export type CreateUserMutation = { __typename?: 'Mutation', createUser: { __typename?: 'UserType', id: string } };

export type CreateWorkspaceMutationVariables = Exact<{ [key: string]: never; }>;


export type CreateWorkspaceMutation = { __typename?: 'Mutation', createWorkspace: { __typename?: 'WorkspaceType', id: string, public: boolean, createdAt: string } };

export type DeleteAccountMutationVariables = Exact<{ [key: string]: never; }>;


export type DeleteAccountMutation = { __typename?: 'Mutation', deleteAccount: { __typename?: 'DeleteAccount', success: boolean } };
...
export type DeleteUserMutation = { __typename?: 'Mutation', deleteUser: { __typename?: 'DeleteAccount', success: boolean } };
...
export type ForkCopilotSessionMutation = { __typename?: 'Mutation', forkCopilotSession: string };

export type CredentialsRequirementFragment = { __typename?: 'CredentialsRequirementType', password: { __typename?: 'PasswordLimitsType', minLength: number, maxLength: number } };

export type PasswordLimitsFragment = { __typename?: 'PasswordLimitsType', minLength: number, maxLength: number };
...
export type GetCopilotHistoryIdsQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', copilot: { __typename?: 'Copilot', histories: Array<{ __typename?: 'CopilotHistories', sessionId: string, messages: Array<{ __typename?: 'ChatMessage', id: string | null, role: string, createdAt: string }> }> } } | null };
...
export type GetCopilotSessionsQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', copilot: { __typename?: 'Copilot', actions: Array<string>, chats: Array<string> } } | null };

export type GetCurrentUserFeaturesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentUserFeaturesQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', id: string, name: string, email: string, emailVerified: boolean, avatarUrl: string | null, features: Array<FeatureType> } | null };

export type GetCurrentUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCurrentUserQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', id: string, name: string, email: string, emailVerified: boolean, avatarUrl: string | null, token: { __typename?: 'tokenType', sessionToken: string | null } } | null };
...
export type GetInviteInfoQuery = { __typename?: 'Query', getInviteInfo: { __typename?: 'InvitationType', workspace: { __typename?: 'InvitationWorkspaceType', id: string, name: string, avatar: string }, user: { __typename?: 'UserType', id: string, name: string, avatarUrl: string | null } } };
...
export type GetMemberCountByWorkspaceIdQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', memberCount: number } };
...
export type GetMembersByWorkspaceIdQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', memberCount: number, members: Array<{ __typename?: 'InviteUserType', id: string, name: string | null, email: string | null, avatarUrl: string | null, permission: Permission, inviteId: string, accepted: boolean, emailVerified: boolean | null }> } };

export type OauthProvidersQueryVariables = Exact<{ [key: string]: never; }>;


export type OauthProvidersQuery = { __typename?: 'Query', serverConfig: { __typename?: 'ServerConfigType', oauthProviders: Array<OAuthProviderType> } };

export type GetPromptsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetPromptsQuery = { __typename?: 'Query', listCopilotPrompts: Array<{ __typename?: 'CopilotPromptType', name: string, model: string, action: string | null, config: { __typename?: 'CopilotPromptConfigType', jsonMode: boolean | null, frequencyPenalty: number | null, presencePenalty: number | null, temperature: number | null, topP: number | null } | null, messages: Array<{ __typename?: 'CopilotPromptMessageType', role: CopilotPromptMessageRole, content: string, params: Record<string, string> | null }> }> };

export type GetServerRuntimeConfigQueryVariables = Exact<{ [key: string]: never; }>;


export type GetServerRuntimeConfigQuery = { __typename?: 'Query', serverRuntimeConfig: Array<{ __typename?: 'ServerRuntimeConfigType', id: string, module: string, key: string, description: string, value: Record<string, string>, type: RuntimeConfigType, updatedAt: string }> };

export type GetServerServiceConfigsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetServerServiceConfigsQuery = { __typename?: 'Query', serverServiceConfigs: Array<{ __typename?: 'ServerServiceConfig', name: string, config: any }> };
...
export type GetUserByEmailQuery = { __typename?: 'Query', userByEmail: { __typename?: 'UserType', id: string, name: string, email: string, features: Array<FeatureType>, hasPassword: boolean | null, emailVerified: boolean, avatarUrl: string | null, quota: { __typename?: 'UserQuota', humanReadable: { __typename?: 'UserQuotaHumanReadable', blobLimit: string, historyPeriod: string, memberLimit: string, name: string, storageQuota: string } } | null } | null };

export type GetUserFeaturesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetUserFeaturesQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', id: string, features: Array<FeatureType> } | null };
...
export type GetUserQuery = { __typename?: 'Query', user: { __typename: 'LimitedUserType', email: string, hasPassword: boolean | null } | { __typename: 'UserType', id: string, name: string, avatarUrl: string | null, email: string, hasPassword: boolean | null } | null };
...
export type GetWorkspaceFeaturesQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', features: Array<FeatureType> } };
...
export type GetWorkspacePageMetaByIdQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', pageMeta: { __typename?: 'WorkspacePageMeta', createdAt: string, updatedAt: string, createdBy: { __typename?: 'EditorType', name: string, avatarUrl: string | null } | null, updatedBy: { __typename?: 'EditorType', name: string, avatarUrl: string | null } | null } } };
...
export type GetWorkspacePublicByIdQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', public: boolean } };
...
export type GetWorkspacePublicPageByIdQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', publicPage: { __typename?: 'WorkspacePage', id: string, mode: PublicPageMode } | null } };
...
export type GetWorkspacePublicPagesQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', publicPages: Array<{ __typename?: 'WorkspacePage', id: string, mode: PublicPageMode }> } };
...
export type GetWorkspaceQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', id: string } };

export type GetWorkspacesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetWorkspacesQuery = { __typename?: 'Query', workspaces: Array<{ __typename?: 'WorkspaceType', id: string, initialized: boolean, owner: { __typename?: 'UserType', id: string } }> };
...
export type ListHistoryQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', histories: Array<{ __typename?: 'DocHistoryType', id: string, timestamp: string, editor: { __typename?: 'EditorType', name: string, avatarUrl: string | null } | null }> } };

export type GetInvoicesCountQueryVariables = Exact<{ [key: string]: never; }>;


export type GetInvoicesCountQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', invoiceCount: number } | null };
...
export type InvoicesQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', invoiceCount: number, invoices: Array<{ __typename?: 'UserInvoice', id: string, status: InvoiceStatus, plan: SubscriptionPlan, recurring: SubscriptionRecurring, currency: string, amount: number, reason: string, lastPaymentError: string | null, link: string | null, createdAt: string }> } | null };
...
export type ListUsersQuery = { __typename?: 'Query', users: Array<{ __typename?: 'UserType', id: string, name: string, email: string, features: Array<FeatureType>, hasPassword: boolean | null, emailVerified: boolean, avatarUrl: string | null }> };

export type PricesQueryVariables = Exact<{ [key: string]: never; }>;


export type PricesQuery = { __typename?: 'Query', prices: Array<{ __typename?: 'SubscriptionPrice', type: string, plan: SubscriptionPlan, currency: string, amount: number | null, yearlyAmount: number | null, lifetimeAmount: number | null }> };
...
export type RecoverDocMutation = { __typename?: 'Mutation', recoverDoc: string };

export type RemoveAvatarMutationVariables = Exact<{ [key: string]: never; }>;


export type RemoveAvatarMutation = { __typename?: 'Mutation', removeAvatar: { __typename?: 'RemoveAvatar', success: boolean } };
...
export type ResumeSubscriptionMutation = { __typename?: 'Mutation', resumeSubscription: { __typename?: 'UserSubscription', id: string | null, status: SubscriptionStatus, nextBillAt: string | null, start: string, end: string | null } };
...
export type RevokeMemberPermissionMutation = { __typename?: 'Mutation', revoke: boolean };
...
export type RevokePublicPageMutation = { __typename?: 'Mutation', revokePublicPage: { __typename?: 'WorkspacePage', id: string, mode: PublicPageMode, public: boolean } };
...
export type SendChangeEmailMutation = { __typename?: 'Mutation', sendChangeEmail: boolean };
...
export type SendSetPasswordEmailMutation = { __typename?: 'Mutation', sendSetPasswordEmail: boolean };
...
export type SendVerifyChangeEmailMutation = { __typename?: 'Mutation', sendVerifyChangeEmail: boolean };
...
export type ServerConfigQuery = { __typename?: 'Query', serverConfig: { __typename?: 'ServerConfigType', version: string, baseUrl: string, name: string, features: Array<ServerFeature>, type: ServerDeploymentType, credentialsRequirement: { __typename?: 'CredentialsRequirementType', password: { __typename?: 'PasswordLimitsType', minLength: number, maxLength: number } } } };
...
export type SetWorkspacePublicByIdMutation = { __typename?: 'Mutation', updateWorkspace: { __typename?: 'WorkspaceType', id: string } };

export type SubscriptionQueryVariables = Exact<{ [key: string]: never; }>;


export type SubscriptionQuery = { __typename?: 'Query', currentUser: { __typename?: 'UserType', id: string, subscriptions: Array<{ __typename?: 'UserSubscription', id: string | null, status: SubscriptionStatus, plan: SubscriptionPlan, recurring: SubscriptionRecurring, start: string, end: string | null, nextBillAt: string | null, canceledAt: string | null }> } | null };
...
export type UpdateAccountFeaturesMutation = { __typename?: 'Mutation', updateUserFeatures: Array<FeatureType> };
...
export type UpdateAccountMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'UserType', id: string, name: string, email: string } };
...
export type UpdateServerRuntimeConfigsMutation = { __typename?: 'Mutation', updateRuntimeConfigs: Array<{ __typename?: 'ServerRuntimeConfigType', key: string, value: Record<string, string> }> };
...
export type UpdateSubscriptionMutation = { __typename?: 'Mutation', updateSubscriptionRecurring: { __typename?: 'UserSubscription', id: string | null, plan: SubscriptionPlan, recurring: SubscriptionRecurring, nextBillAt: string | null } };
...
export type UpdateUserProfileMutation = { __typename?: 'Mutation', updateProfile: { __typename?: 'UserType', id: string, name: string } };
...
export type UploadAvatarMutation = { __typename?: 'Mutation', uploadAvatar: { __typename?: 'UserType', id: string, name: string, avatarUrl: string | null, email: string } };
...
export type GetEnableUrlPreviewQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', enableUrlPreview: boolean } };
...
export type SetEnableUrlPreviewMutation = { __typename?: 'Mutation', updateWorkspace: { __typename?: 'WorkspaceType', id: string } };
...
export type EnabledFeaturesQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', features: Array<FeatureType> } };
...
export type AvailableFeaturesQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', availableFeatures: Array<FeatureType> } };
...
export type SetWorkspaceExperimentalFeatureMutation = { __typename?: 'Mutation', setWorkspaceExperimentalFeature: boolean };
...
export type AddWorkspaceFeatureMutation = { __typename?: 'Mutation', addWorkspaceFeature: number };
...
export type ListWorkspaceFeaturesQuery = { __typename?: 'Query', listWorkspaceFeatures: Array<{ __typename?: 'WorkspaceType', id: string, public: boolean, createdAt: string, memberCount: number, features: Array<FeatureType>, owner: { __typename?: 'UserType', id: string } }> };
...
export type RemoveWorkspaceFeatureMutation = { __typename?: 'Mutation', removeWorkspaceFeature: number };
...
export type AcceptInviteByInviteIdMutation = { __typename?: 'Mutation', acceptInviteById: boolean };
...
export type WorkspaceQuotaQuery = { __typename?: 'Query', workspace: { __typename?: 'WorkspaceType', quota: { __typename?: 'QuotaQueryType', name: string, blobLimit: number, storageQuota: number, historyPeriod: number, memberLimit: number, memberCount: number, usedSize: number, humanReadable: { __typename?: 'HumanReadableQuotaType', name: string, blobLimit: string, storageQuota: string, historyPeriod: string, memberLimit: string } } } };
